...
CCSSDlg::CCSSDlg(CWnd* pParent /*=NULL*/)
	: CDialog(CCSSDlg::IDD, pParent)
{
	//{{AFX_DATA_INIT(CCSSDlg)
	m_strConnNumber = _T("");
	m_strLocalIP = _T("");
	m_strRecePack = _T("");
	m_strRumTime = _T("");
...
void CCSSDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CCSSDlg)
...
BEGIN_MESSAGE_MAP(CCSSDlg, CDialog)
	//{{AFX_MSG_MAP(CCSSDlg)
	ON_WM_TIMER()
	ON_WM_CLOSE()
...
/////////////////////////////////////////////////////////////////////////////
// CCSSDlg message handlers

BOOL CCSSDlg::OnInitDialog() 
{
...
//////////////////////////////////////////////////////////////////////////
//	更新窗口状态
void  CCSSDlg::UpdateWindowState( void ){
...
//////////////////////////////////////////////////////////////////////////
//  连接状态
void CCSSDlg::IsConnectionStatus( BOOL  bStateus ){
...
//////////////////////////////////////////////////////////////////////////
//
void CCSSDlg::OnTimer(UINT nIDEvent) 
{
	if ( IsWindowVisible()){
		UpdateWindowState();
		UpdateData(FALSE);
...
void CCSSDlg::OnPropertyButton(){
	...
	if ( oConfigDlg.DoModal() == IDOK ){
		if ( m_bStart ){	
			strData.Format("CSS %s", GetLangStr( TEXT_RUN_PAEASE_STOP_FIRST ) );	
...
//////////////////////////////////////////////////////////////////////////
//   显示数据信息
BOOL CCSSDlg::SetRecHelpInfo( int	nDataLen, BOOL	bRecv){
